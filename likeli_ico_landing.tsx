...
import { ArrowRight, CheckCircle, Lock, TrendingUp, Users, Shield, Zap, Target, Rocket, Star, Crown, Award, Gift, Percent, Clock, DollarSign, BarChart3, Globe, Sparkles } from 'lucide-react';
...
export default function LikeliICO() {
  ...
  const tiers = [
    ...
    { name: 'Platinum', min: 25000, max: null, bonus: '25%', multiplier: '5x', discount: '25%', color: 'from-purple-400 to-purple-600', icon: Sparkles }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrollY > 50 ? 'bg-black/95 backdrop-blur-xl shadow-2xl border-b border-blue-500/20' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-xl flex items-center justify-center font-bold text-xl shadow-lg shadow-blue-500/50 animate-pulse">L</div>
            <div>
              <span className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Likeli.io</span>
          ...
          <button className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 px-8 py-3 rounded-xl font-bold hover:shadow-2xl hover:shadow-purple-500/50 transition-all transform hover:scale-105 animate-pulse">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-2xl text-gray-300 mb-4 max-w-3xl mx-auto leading-relaxed">
              The most anticipated DeFi launch of 2026. Predict elections, sports, crypto prices and more with <span className="text-blue-400 font-bold">up to 10x leverage</span> using native crypto assets.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-sm border-2 border-blue-400/30 rounded-2xl p-6 text-center transform hover:scale-105 transition-all">
              <div className="text-blue-400 mb-2"><Users size={32} className="mx-auto" /></div>
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm border-2 border-purple-400/30 rounded-2xl p-6 text-center transform hover:scale-105 transition-all">
              <div className="text-purple-400 mb-2"><DollarSign size={32} className="mx-auto" /></div>
            ...
            <div className="bg-gradient-to-br from-pink-500/20 to-red-500/20 backdrop-blur-sm border-2 border-pink-400/30 rounded-2xl p-6 text-center transform hover:scale-105 transition-all">
              <div className="text-pink-400 mb-2"><TrendingUp size={32} className="mx-auto" /></div>
          ...
          <div className="mb-12">
            ...
            <div className="flex justify-center gap-4">
              {Object.entries(countdown).map(([unit, value]) => (
                <div key={unit} className="bg-gradient-to-b from-gray-800 to-black border-2 border-blue-500/50 p-8 rounded-2xl shadow-2xl shadow-blue-500/30 min-w-[120px]">
                  <div className="text-5xl font-black text-transparent bg-gradient-to-br from-blue-400 to-purple-400 bg-clip-text">{String(value).padStart(2, '0')}</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <div key={i} className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border-2 border-gray-700 hover:border-blue-500/50 p-8 rounded-2xl transform hover:scale-105 hover:-translate-y-2 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-blue-500/20">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-gradient-to-br from-gray-800 to-gray-900 border-2 border-gray-700 hover:border-purple-500/50 p-8 rounded-2xl hover:scale-105 transition-all shadow-xl">
                <div className="mb-4">{item.icon}</div>
                <div className="text-gray-400 text-sm mb-2 uppercase font-semibold">{item.label}</div>
                <div className="text-4xl font-black mb-2 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">{item.value}</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-2xl text-gray-300 max-w-4xl mx-auto">
              The earlier you invest, the bigger your tier. Higher tiers equals <span className="text-yellow-400 font-bold">massive bonuses</span>, <span className="text-green-400 font-bold">multipliers</span>, and <span className="text-purple-400 font-bold">lifetime perks</span>.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {tiers.map((tier, i) => {
              ...
              return (
                <div key={i} className="group relative bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl border-2 border-gray-700 hover:border-transparent overflow-hidden transform hover:scale-105 hover:-translate-y-3 transition-all duration-300 shadow-2xl">
                  ...
                  <div className="p-8 relative z-10">
                    ...
                    <h3 className="text-3xl font-black mb-3 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">{tier.name}</h3>
          ...
          <div className="text-center bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border-2 border-yellow-500/50 rounded-2xl p-8">
            ...
            <p className="text-lg text-white">First 1,000 investors get an <span className="text-yellow-400 font-black">EXTRA 5% bonus</span> on top of tier bonuses!</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="text-center bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border-2 border-gray-700 p-10 rounded-2xl">
                <div className="text-6xl font-black mb-3 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">{item.metric}</div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center font-bold text-sm">L</div>
                <span className="text-xl font-bold">Likeli.io</span>
              </div>
              <p className="text-gray-400 text-sm">The world's first leveraged prediction market using native crypto assets.</p>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Resources</h4>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="#" className="hover:text-blue-400">Whitepaper</a></li>
